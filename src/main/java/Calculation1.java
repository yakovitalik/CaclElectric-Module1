...
public class Calculation1 extends JFrame {
    ...
    public Calculation1(String s) {
        ...
        comboList1 = new JComboBox<String>(boxList);

        // добавляем поля во фрейм
        comboList1.setSelectedIndex(0);
        comboList1.addActionListener(handler);
        add(label1);
        add(text1);
        add(label2);
        add(comboList1);
